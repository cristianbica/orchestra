...
|---------|---------|----------|
| **Workflow routing** | Conductor uses intake questions to route to correct workflow | document, implement-feature, fix-bug, refactor, trivial-change |
...
- [agent-roles.md](agent-roles.md) — How the 5 agents interact while respecting boundaries
